...
function informationletterRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of informationletterComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function pranksLoopLoopBegin(pranksLoopLoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisPranksLoop of pranksLoop) {
...
function promptLoopLoopBegin(promptLoopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisPromptLoop of promptLoop) {
...
function numberRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of numberComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function incrementPromptRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of incrementPromptComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function incrementPrankRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of incrementPrankComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function respectroutineRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of respectroutineComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function angerroutineRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of angerroutineComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function demoroutineRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of demoroutineComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
